...
local clash = require("plugins.clash")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "d", function()
        awful.spawn.single_instance("rofi -show drun")
    end, {
        description = "rofi",
        group = "launcher",
    }),
    ...
    awful.key({ modkey }, "r", function()
        awful.spawn.single_instance("rofi -show run")
    end, {
        description = "runner",
        group = "launcher",
    }),
    ...
    awful.key({}, "Print", function()
        awful.spawn.single_instance("ksnip -r")
    end, {
        description = "flameshot",
        group = "custom",
    }),

    awful.key({ modkey, "Shift" }, "y", clash.on, {
        description = "turn on clash",
        group = "custom",
    }),

    awful.key({ modkey, "Control" }, "y", clash.off, {
        description = "turn off clash",
        group = "custom",
    }),
...
-- Video wallpaper
------------------------------------------------------------------------------------
--awful.spawn.with_shell("~/Scripts/video_wp.sh")
